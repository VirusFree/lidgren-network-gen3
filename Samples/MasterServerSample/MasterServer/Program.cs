                        ...
                        case NetIncomingMessageType.UnconnectedData:
                            ...
                            switch ((MasterServerMessageType)msg.ReadByte())
                            {
                                case MasterServerMessageType.RegisterHost:
                                    ...
                                    Console.WriteLine("Got registration for host " + id + ", external IP : " + msg.SenderEndPoint);
                                ...
                                case MasterServerMessageType.RequestIntroduction:
                                    ...
                                    if (registeredHosts.TryGetValue(hostId, out elist))
                                    {
                                        ...
                                        Console.WriteLine($"Sending introduction... host internal:{elist[0]} , host external:{elist[1]} , client internal:{clientInternal} , client external:{msg.SenderEndPoint}");
                                        peer.Introduce(
